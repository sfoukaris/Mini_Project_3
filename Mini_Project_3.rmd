...
![MacLeish Field Station](https://goo.gl/images/QmQ4us)
...
map <- leaflet() %>%
  ...
  # Stay Close to Trails, Streams (in 61 m buffer), Parking (805 m)
...
We feel, based on the evidence presented, that Smith College should build two basic campgrounds providing sleeping space for 12 with fire rings for open cooking. The estimated time is aproximately two to four weeks per site. The cost to outfit each site will range between $4,000 to $6,000 per site. Smith College should have all of the required tools for groundwork. Fire Rings for the cooking facilities are available at any home improvement warehouse. The initial outfiting for student supplies, such as tents, sleeping bags, and other camping gear can be acquired at a rate of aproximately $350 per student initial investment. 


###Sites Chosen

For our proposal sites, we chose the abandoned field at the bottom middle MacLeish Field Station quadrant boundary. This would minimize environmental impact as well as provide useful life for an area of underutilized land. We also propose the utilization of the Sugarloaf Forrest for it's tranquil setting. The Sugarloaf Forrest is utilized for maple sap currently, but due to the temperature requirements to facilitate the sap tapping, it would not be desirable to camp at the same time as the maple tapping.; therefore there would be no overlap. 
